...
public class Extractor {
    ...
    private void extractBlokedSites() throws SQLException {
        ...
        //Pls help qual o tipo de excepção que devo utilizar :( ?
        Set<String> it = null;
        try {
            it = ISPLockedWebsites.INSTANCE.readJsonFromUrl("https://tofran.github.io/PortugalWebBlocking/blockList.json").keySet();
        } catch (Exception e) {
            e.printStackTrace();
        }
